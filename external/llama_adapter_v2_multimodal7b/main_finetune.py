...
def get_args_parser():
    ...
    parser.add_argument('--llama_path', default="../../consolidated", type=str,
                        help='path to LLaMA pretrained checkpoint')
    parser.add_argument('--pretrained_path', default='/path/to/pretrained', type=str,
                        help='path to checkpoint from pretrain stage')
    parser.add_argument('--max_seq_len', default=2048, type=int,
                        help='max number of input tokens') # MUST SET MODEL ARGS T0 2048
    ...
    # Dataset parameters
    parser.add_argument('--data_config', default='davinci_data.yaml', type=str,
