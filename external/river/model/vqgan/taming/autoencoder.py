...
# https://heibox.uni-heidelberg.de/f/0e42b04e2e904890a9b6/?dl=1 ####### changed to 128 for now!!!!!!
# vq_f16_ddconfig = dict(embed_dim=128, n_embed=16384, double_z=False, z_channels=128,
...
#                       out_ch=3, ch=128, ch_mult=[1, 1, 2, 2, 4], num_res_blocks=2, attn_resolutions=[16], dropout=0.0) # original

vq_f16_ddconfig = dict(embed_dim=8, n_embed=1024, double_z=False, z_channels=8, resolution=128, in_channels=3,
                       out_ch=3, ch=128, ch_mult=[1, 1, 2, 2, 4], num_res_blocks=2, attn_resolutions=[16], dropout=0.1) # from vqgan_river davinci
