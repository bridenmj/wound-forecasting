import sys
sys.path.append("/content/drive/MyDrive/Heals_Winter_24") # Move to train.py
...
from Shared.vq.vqvae_muse import VQGANModel, get_tokenizer_muse, VQMuseEncoder
...
class Model(nn.Module):
    def __init__(self, config: Configuration):
        ...
        self.ae = VQMuseEncoder(get_tokenizer_muse())
    ...
    def forward(
        ...
        conditioning_frames_indices = target_frames_indices - 2
        ...
        with torch.no_grad():
            ...
            # print("reference_frames:", reference_frames.shape)
            # print("conditioning_frames:", conditioning_frames.shape)
            # print("input_frames:", input_frames.shape)
            # print("flat_input_frames:", flat_input_frames.shape)
            # print("flat_latents:", flat_latents.shape)
